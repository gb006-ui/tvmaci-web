window.addEventListener("DOMContentLoaded", () => {
  ...
  window.openGame = function() {
    fetch("https://api.countapi.xyz/hit/tvmaci/ugralos");
    showTransition(() => {
        hideAllPages();
    ...
    window.openPuzzle = function() {
        fetch("https://api.countapi.xyz/hit/tvmaci/puzzle");
        showTransition(() => {
            hideAllPages();
    ...
    window.openMemory = function() {
        fetch("https://api.countapi.xyz/hit/tvmaci/memoria");
        showTransition(() => {
            hideAllPages();
    ...
    function startPong() {
        ...
        // Irányítás – globális, de csak pongRunning alatt számít
    ...
    window.openPong = function () {
        fetch("https://api.countapi.xyz/hit/tvmaci/pong");
        showTransition(() => {
            hideAllPages();
    ...
    /* ============================
       MOBIL UGRÁS GOMB – UGRÁLÓS
    ============================ */

    function simulateKey(code, type) {
        const evt = new KeyboardEvent(type, { code, key: code });
    ...
    if (jumpBtn) {
        ...
        jumpBtn.addEventListener("mouseleave", release);
    }
});
