window.addEventListener("DOMContentLoaded", () => {
    ...
    window.closePuzzle = function() {
        ...
        document.getElementById("jatek").style.display = "block";
        wwindow.scrollTo({ top: 0, behavior: "smooth" });
...
window.setPongDifficulty = function(level) {
    if (level === "slow") pongSpeed = 0.7;
    if (level === "normal") pongSpeed = 1;
    if (level === "fast") pongSpeed = 1.4;
};
    ...
    function startPong() {
        ...
        function resetBall(direction) {
            ...
            const baseSpeed = 3.5;
            ball.dx = direction * baseSpeed * pongSpeed;
            ball.dy = (Math.random() * 2 - 1) * baseSpeed * 0.6 * pongSpeed;
        ...
        // Paprikajancsi (bal oldal)
        bindTouch(p1Up,   () => p1.dy = -5, () => p1.dy = 0);
        bindTouch(p1Down, () => p1.dy =  5, () => p1.dy = 0);

        // TV Maci (jobb oldal)
        bindTouch(p2Up,   () => p2.dy = -5, () => p2.dy = 0);
        bindTouch(p2Down, () => p2.dy =  5, () => p2.dy = 0);
    ...
    // ===== PUZZLE ÚJRA KEVERÉS =====
window.reshufflePuzzle = function() {
